...
def activation_quant(x: torch.Tensor):
    """
    Quantize the activation tensor to scaled 8 bit,
    based on the mean of the absolute values described by
    https://github.com/microsoft/unilm/blob/master/bitnet/The-Era-of-1-bit-LLMs__Training_Tips_Code_FAQ.pdf
...
def activation_post_quant(x_norm: torch.Tensor):
    ...
    github.com/microsoft/unilm/blob/master/bitnet/The-Era-of-1-bit-LLMs__Training_Tips_Code_FAQ.pdf
